// Code generated by tools of liuli`s  DO NOT EDIT.
package chat
...
var grpc_msg = []msg_buff{{Name: "newHelloRequest", MsgType: func() interface{} {
	return new(HelloRequest)
}}, {Name: "newStringSlice", MsgType: func() interface {
} {
	return new(StringSlice)
}}, {Name: "newHelloReply", MsgType: func() interface {
} {
	return new(HelloReply)
}}, {Name: "newPhoneInfo", MsgType: func() interface {
} {
	return new(PhoneInfo)
}}, {Name: "newRequest", MsgType: func() interface {
} {
	return new(Request)
}}, {Name: "newNone", MsgType: func() interface {
} {
	return new(None)
}}, {Name: "newResponse", MsgType: func() interface {
} {
	return new(Response)
}}, {Name: "newHelloRequest", MsgType: func() interface {
} {
	return new(HelloRequest)
}}, {Name: "newPingValue", MsgType: func() interface {
} {
	return new(PingValue)
}}, {Name: "newIperfValue", MsgType: func() interface {
} {
	return new(IperfValue)
}}}
var grpc_jsm *js.JSManager
...
func init() {
	if grpc_jsm == nil {
		setup()
		grpc_jsm.ChangefileMonitor("grpc", func(jsm *js.JSManager) {
			setup()
			grpc_server.Stop()
...
func setup() {
	...
	for _, tp := range grpc_msg {
		g.Object().Set(tp.Name, func() interface{} {
			return tp.MsgType()
		})
	}
...
func NewMethodsHandle(FullMethod string, in interface{}, Func func(context.Context) (interface{}, error)) Methods {
	...
	return func(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
		...
		info := &grpc.UnaryServerInfo{Server: srv, FullMethod: m.FullMethod}
...
func Packe_servierDesc(sd *grpc.ServiceDesc) *grpc.ServiceDesc {
	_sd_ := &grpc.ServiceDesc{ServiceName: sd.ServiceName, HandlerType: nil, Methods: []grpc.MethodDesc{}, Metadata: sd.Metadata}
	...
	for _, fc := range v.Object().Keys() {
		...
		if fv.IsObject() && len(fc) > 0 && unicode.IsUpper(rune(fc[0])) {
			...
			in, _ := In.Export()
			_sd_.Methods = append(_sd_.Methods, grpc.MethodDesc{MethodName: fc, Handler: NewMethodsHandle(fmt.Sprintf("/%v/%v", sd.ServiceName, fc), in, func(ctx context.Context) (interface{}, error) {
